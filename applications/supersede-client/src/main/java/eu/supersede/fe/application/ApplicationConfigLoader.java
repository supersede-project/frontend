    ...
    public void load()
    {
        ...
        if (applicationName != null)
        {
            ...
            for (String pageName : pageNames)
            {
                ...
                String[] pageProfiles = env.getRequiredProperty("application.page." + pageName + ".profiles")
                        .split(",");
            ...
            if (gadgets != null)
            {
                for (String gadget : gadgets)
                {
                    ...
                    String[] gadgetProfiles = env.getRequiredProperty("application.gadgets." + gadget + ".profiles")
                            .split(",");
